...
export default function TrainerCheckoutPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#2A2A2A] via-gray-800 to-gray-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-white mb-4">Invalid Booking</h1>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { paymentIntentId, invoiceNumber, orderNumber } = await response.json();
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Booking Summary */}
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 h-fit">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="border-t border-gray-600 pt-3">
                  <div className="flex justify-between text-[#D5FC51] font-bold text-lg">
                    <span>Total:</span>
                    <span>${totalPrice}{sessionType === 'package' ? ' (25% savings)' : ''}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.firstName ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                      placeholder="John"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.lastName ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                      placeholder="Doe"
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.address ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={formData.city}
                      onChange={handleInputChange}
                      className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.city ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.zipCode ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                      placeholder="10001"
                    />
                ...
                <div className="border-t border-gray-600 pt-6 mt-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.cardNumber ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.expiryDate ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                        placeholder="MM/YY"
                        maxLength={5}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formData.cvv}
                        onChange={handleInputChange}
                        className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.cvv ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                        placeholder="123"
                        maxLength={3}
                      />
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full p-3 rounded-xl bg-gray-700 border ${errors.cardName ? 'border-red-500' : 'border-gray-600'} text-white focus:border-[#D5FC51] focus:outline-none`}
                ...
                >
                  {isLoading ? "Processing..." : `Pay $${totalPrice} - Complete Booking`}
                </button>
              </form>
            </div>
          </div>
